...
public class ZonedDateTimeTypeAdapter
  ...
  public JsonElement serialize(
    ...
    return new JsonPrimitive(Constant.ZONED_DATE_TIME_FORMATTER.format(zonedDateTime));
  }
  ...
  public ZonedDateTime deserialize(
    ...
    return ZonedDateTime.parse(
        json.getAsJsonPrimitive().getAsString(), Constant.ZONED_DATE_TIME_FORMATTER);
  }
}
